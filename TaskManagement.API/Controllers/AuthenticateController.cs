...
using TaskManagement.Application.Common.AuthenticationModels;
...
namespace TaskManagement.API.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public AuthenticateController(UserManager<User> userManager, RoleManager<Role> roleManager, IOptions<Jwt> options)
        {
